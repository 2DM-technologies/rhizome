...
inapplicable because there is nothing sensible to name; null is not an error. Do not use Vibe-level context. Use each record's
clipped flag and the context counts to account for omitted or clipped data without inventing it.
