...
Owner-requested import naming follow-up (2026-09-12): the import review has no title field. Confirming a new Vibe uses the source's `destination.title`, including the captured Are.na channel name and X's existing account title, or `Imported objects` when the source supplies no name. The reviewed confirmation gate and cancellation behavior remain in place. Imports into existing Vibes keep their title; owners can rename any Vibe through its inline title editor.
